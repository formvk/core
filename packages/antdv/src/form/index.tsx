import type { Form as FormType, IFormFeedback } from '@formvk/core'
import { FormProvider, useForm } from '@formvk/vue'
  ...
  setup(props, { attrs, slots }) {
    ...
    return () => {
      ...
      const renderContent = (form: FormType) => {
        const Com = component as typeof AntForm
        return (
          <PreviewText.Placeholder value={previewTextPlaceholder}>
            <Com
              ...
              onSubmit={(e: Event) => {
                e?.stopPropagation?.()
                e?.preventDefault?.()
                form.submit(onAutoSubmit as (e: any) => void).catch(onAutoSubmitFailed as (e: any) => void)
              }}
            >
