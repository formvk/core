import type { Form, IFormProps } from '@formvk/core'
import { createForm } from '@formvk/core'
import { toJS } from '@formvk/reactive'
import { observer } from '@formvk/reactive-vue'
import type { IMiddleware } from '@formvk/shared'
import { applyMiddleware, isBool, isFn, isNum, isStr } from '@formvk/shared'
import { FormProvider } from '@formvk/vue'
  ...
  const formDialog = {
    ...
    open: async (props: IFormProps) => {
      ...
      env.promise = new Promise(async (resolve, reject) => {
        try {
          props = await loading(dialogProps.loadingText, () => applyMiddleware(props, env.openMiddlewares))
        ...
        renderDialog(
          ...
          async () => {
            await loading(dialogProps.loadingText, () => applyMiddleware(env.form, env.cancelMiddlewares))
            formDialog.close()
          }
        )
      })
