...
export const getFormLayoutProps = () => {
  return {
    ...
    colon: { default: true },
    labelAlign: {
      type: [String, Array] as PropType<'right' | 'left'>,
    },
    wrapperAlign: {
      type: [String, Array] as PropType<'right' | 'left'>,
    },
...
export const FormLayoutDeepContext: InjectionKey<Ref<FormLayoutProps>> = Symbol('FormLayoutDeepContext')
