...
import { markRaw, model } from '@formvk/reactive'
        ...
        return (
          ...
          >
            {panels.map(({ props, schema, name }) => {
              ...
              return (
                <Collapse.Panel key={name} {...restProps} forceRender header={badgedHeader(name, header)}>
...
export const FormCollapse = Object.assign(_FormCollapse, {
  CollapsePanel,
  createFormCollapse,
})
