...
export const getLocaleByPath = (path: string, lang: string = registry.locales.language) =>
...
export const getValidateFormats = (key?: string) => (key ? registry.formats[key] : registry.formats)
