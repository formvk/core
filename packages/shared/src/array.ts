...
export function each<T extends object, TValue extends T[keyof T]>(
  val: T,
...
export function map<T>(val: string, iterator: MapStringIterator<T>, revert?: boolean): T[]
...
export function reduce<T, U>(val: T[], iterator: MemoArrayIterator<T, U>, accumulator?: U, revert?: boolean): U
export function reduce<T>(val: string, iterator: MemoStringIterator<T>, accumulator?: T, revert?: boolean): T
export function reduce<T extends object, TValue extends T[keyof T], TResult = any>(
  val: T,
...
export function every<T extends string>(val: T, iterator: EachStringIterator, revert?: boolean): boolean
export function every<T>(val: T[], iterator: EachArrayIterator<T>, revert?: boolean): boolean
export function every<T extends object>(val: T, iterator: EachObjectIterator, revert?: boolean): boolean
...
export function some<T extends string>(val: T, iterator: EachStringIterator, revert?: boolean): boolean
export function some<T>(val: T[], iterator: EachArrayIterator<T>, revert?: boolean): boolean
export function some<T extends object>(val: T, iterator: EachObjectIterator, revert?: boolean): boolean
...
export function findIndex<T extends string>(val: T, iterator: EachStringIterator, revert?: boolean): number
export function findIndex<T>(val: T[], iterator: EachArrayIterator<T>, revert?: boolean): number
export function findIndex<T extends object>(val: T, iterator: EachObjectIterator, revert?: boolean): keyof T
...
export function find<T extends object>(val: T, iterator: EachObjectIterator, revert?: boolean): T[keyof T]
...
export function includes<T extends string>(val: T, searchElement: string, revert?: boolean): boolean
