...
export const traverse = (target: any, visitor: (value: any, path: Array<string | number>) => void) => {
...
export const traverseSchema = (schema: ISchema, visitor: (value: any, path: any[], omitCompile?: boolean) => void) => {
...
export const patchStateFormSchema = (targetState: any, pattern: any[], compiled: any) => {
  untracked(() => {
